...
class TravelForm extends React.Component {
    ...
    handleThumbnailImgUpload = ( e ) => {
        ...
        this.props.dispatch( fileUploadToStorage( this.state.uniqueId, image, "Thumbnail-Image", ( url ) => {
            this.setState({
    ...
    handleLandscapeImgUpload = ( e ) => {
        ...
        this.props.dispatch( fileUploadToStorage( this.state.uniqueId, image, "Landscape-Image", ( url ) => {
            this.setState({
    ...
    handleTravelImgsUpload = ( e ) => {
        ...
        for ( const file in files ){
            ...
            if ( /\.(jpe?g|png|gif)$/i.test( files[ file ].name ) ) {
                ...
                this.props.dispatch( fileUploadToStorage( this.state.uniqueId, files[ file ], `travelImg-${ uniqueImageId }`, ( url ) => {
                    
                    const travelImgObj = { travelImageUrl : url, id : `travelImg-${ uniqueImageId }` }
                    this.setState({
    ...
    render(){
        ...
        return(
            ...
            <Form onSubmit = { (e) => { e.preventDefault(); } }>
                ...
                <Button color="danger" size="lg" className="contact_text_format" onClick = { this.submitTravelNote } >Submit</Button>
