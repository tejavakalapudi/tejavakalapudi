...
class AboutMePage extends React.Component {
  isAboutMePage = () => {
    return (
      ...
      this.props.location.pathname.search('about') > -1
    );
  };
  ...
  state = {
    ...
    summaryContent:
      this.props && !this.props.isHomePage
        ? 'Hi, I am Ravi. A Front End developer and a Web Enthusiast skilled in technologies like JavaScript, React JS, Bootstrap, HTML and CSS. I create clean, professional and functional websites.'
  ...
  render() {
    return (
      <div className={`about__container ${this.state.homePageClass}`}>
        {this.state.isAboutMePage && <ScrollToTop />}

        <Container className="about__container-padding">
          <Row className="about__section justify-content-center">
            <Col
              xs="11"
              lg={this.state.isAboutMePage ? '11' : '3'}
              className="text__align-center"
            >
              <img
                src={AboutMeImage}
                className={`about__image-rounded ${this.state.homePageClass}`}
              />
            </Col>

            <Col xs="11" lg={this.state.isAboutMePage ? '11' : '9'}>
              <div
                className={`section__title text__align-center ${
                  this.state.homePageClass
                }`}
              >
                About me.
              </div>
              ...
              <div
                className={`about__description text__align-center ${
                  this.state.homePageClass
                }`}
              >
                ...
                <div>
                  ...
                  <Row className="justify-content-center">
                    <Col className="about__content" xs="12">
                      ...
                      of working in an entertainment industry. Skilled in front
                      end development and familiar in integrating 3rd party ads
                      & analytics frameworks like Freewheel, DoubleClick,
                      Omniture and Comscore. I spend my days crafting websites
                      and also sometimes annoying people by delivering ads on
                      video content.
                    </Col>
                    <Col className="about__content" xs="12">
                      I love working for all size of companies from small local
                      businesses right up to huge international brands like
                      Viacom. I’ve just spent 5 years living in the USA with 2
                      years of education at Washington DC and 3 years of work
                      experience at New York City. The love for the home country
                      always have motivated me to plan on moving back to India
                      and serve the nation in whatever way I can. I feel
                      fortunate about getting an oppurtunity to analyze and
                      compare pros and cons within the work culture of both
                      countries.
                    </Col>
                    <Col className="about__content" xs="12">
                      My vision is to make use of my experience and expertise to
                      establish an organization which will mostly be focused on
                      making lives easy in real time by also keeping up to date
                      with the evoluting technologies. I also want to use this
                      an oppurtunity to promote the uses of modern work culture
                      where an employee is treated with more respect and
                      freedom.
                    </Col>
                    <Col className="about__content" xs="12">
                      I’m constantly learning web technologies and other design
                      related topics, mostly focused on JavaScript related
                      frameworks and currently playing around React JS, Redux,
                      Bootstrap 4, Firebase Database/Storage.
                    </Col>
                    <Col className="about__content" xs="12">
                      <div>Other than Internet,</div>
                      <div>
                        I am also interested in travelling. I am always excited
                        about meeting new people. I love to Eat, Drink and Cook.
                        I like playing games on my xbox especially Fifa.
                        Inspired by new technologies like VR, AR and
                        Cryptocurrencies.{' '}
                      </div>
                    </Col>
                  </Row>
                  ...
                  <div className="about__segment">
                    <div className="about__segment-title">Work.</div>
                  ...
                  <Row className="justify-content-center">
                    <Col
                      ...
                      md="6"
                      lg="4"
                      className="text__align-center about__imageTile"
                    >
                      <Card>
                  ...
                  {/****** Tech Stack Segment ******/}
                  <div className="about__segment">
                    <div className="about__segment-title">Tech Stack.</div>
                    <hr className="about__segment-line" />
                  </div>
                  ...
                  {/****** Resume Segment ******/}
                  <div className="about__segment">
                    <div className="about__segment-title">Resume.</div>
                  </div>
                  ...
                  <Row className="justify-content-center about__resume">
                    <Col
                      ...
                      md="6"
                      lg="5"
                      className="text__align-center about__resume-imageCol"
                    >
                      <Card>
                        <CardImg
                          top
                          src={ResumePageOne}
                          alt="Card image cap"
                          className="about__resume-image"
                          onClick={() => {
                            this.enlargeResume(1);
                          }}
                        />
                      </Card>
                    </Col>
                  ...
                  <Modal
                    isOpen={
                      this.state.enlargeResumePageOne ||
                      this.state.enlargeResumePageTwo
                    }
                  ...
                  <div className="about__segment-others">
                    <div className="about__segment-title">Others.</div>
                    <hr className="about__segment-line" />
                  </div>
                  ...
                  <Row className="justify-content-center about__others-row">
                    <Col
                      ...
                      onClick={() => {
                        this.redirectToRoute('traveldiaries');
                      }}
                    >
                      <Card className="travel__card">
                        <CardImg top src={Travel} alt="Card image cap" />
                        <div className="travel__card-overlay about__overlay" />
                    ...
                    <Col
                      ...
                      className="text__align-center travel__image-container"
                      onClick={() => {
                        this.redirectToRoute('testimonials');
                      }}
                    >
                      <Card className="travel__card">
