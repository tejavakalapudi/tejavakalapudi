...
class Testimonials extends React.Component {
  state = {
    itemsToView:
      this.props && !this.props.isHomePage && this.props.testimonials
    ...
    return (
      <div className="testimonial__container">
        ...
        <Container className="testimonial__container-padding">
                      ...
                      <Col
                        ...
                        style={{
                          borderLeft: `3px solid ${
                            this.state.borderColors[index]
                          }`
                        }}
                      >
                        <div className="testimonial__content text__align-center">{` "${
                          testimonial.testimonial
                        }" `}</div>
                        <div className="testimonial__name text__align-right">{` ${
                          testimonial.name
                        } `}</div>
                        <div className="testimonial__title text__align-right">{`${
                          testimonial.title
                        }`}</div>
                      </Col>
                    );
          ...
          {this.props.testimonials &&
            this.props.testimonials.length > 3 &&
