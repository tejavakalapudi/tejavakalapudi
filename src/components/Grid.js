                    ...
                    <div className = "home__grid col-lg-10 col-md-11 mx-auto">
                        <CardColumns>
                            <Card className = "card__zoom" >
                                <CardImg top width="320px" src={this.props.projects[ 0 ].thumbnailLocation} alt="Card image cap" />
                            </Card>
                            ...
                            <Card className = "card__zoom">
                                <CardImg top width="320px" src={ this.props.projects[ 1 ].thumbnailLocation } alt="Card image cap" />
                            </Card>
                            ...
                            <Card className = "card__zoom" >
                                <CardImg top width="320px" src={ this.props.projects[ 2 ].thumbnailLocation } alt="Card image cap" />
                            </Card>
