...
import { BootstrapLogo, ReactLogo, FireBaseLogo, HerokuLogo, SassLogo } from "../components/TechLogos";

const FooterPage = () => ( 
    <Container> 
        <Row className = "footer justify-content-center">
            <Col lg="4" md = "4" sm = "11" xs="11" className = "footer__copyright" >
                © Copyright <b className = "footer__copyright-company">Akruthi Constructions.</b> All Rights Reserved.
            </Col>
