...
const addExpense = ( { id = "", description = "", note = "", createdOn = 0, amount = 0 } = {} ) => ({
    type : "ADD_EXPENSE",
    expense : {
        id : uuid(),
        description,
...
const expenseOne = store.dispatch( addExpense( { description : "Rent", amount : 200, createdOn : 1000 } ) );
const expenseTwo =  store.dispatch( addExpense( { description : "Coffee", amount : 100, createdOn : -500 } ) );
